...
def make_test_train_splits(df,target_col,target_class_col,test_size,valid_size=0):
    ...
    y_test = X_test.pop(target_class_col)
    y_valid = X_valid.pop(target_class_col)
    y_train = X_train.pop(target_class_col)
    y_train_valid = X_train_valid.pop(target_class_col)
